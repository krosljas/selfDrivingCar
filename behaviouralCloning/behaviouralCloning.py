...
Original file is located at
    https://colab.research.google.com/drive/1FfoBWAIDoPDneAPy9lXZINZ_LUiu2y81
"""
...
# Acts as a coroutine - ie Generator function
def batch_generator(image_paths, steering_ang, batch_size, istraining):
  ...
  while True:
    ...
    for i in range(batch_size):
      ...
      if istraining:
        img, steer = random_augment(image_paths[random_index], steering_ang[random_index])
